...
# Author: VoltOfficial
# Source: https://github.com/Voltblockchain/VOLT-MultiMN
...
function cmd_install() {
	...
	[[ ! $(grep "addnode=165.232.91.211" $new_folder/$COIN_CONFIG) ]] && echo "addnode=165.232.91.211" >> $new_folder/$COIN_CONFIG
...
function cmd_bootstrap() {
	...
	#For copied bootstrap data while new node installation // Ex. : multimn install volt --bootstrap
...
function cmd_help() {
	echo -e "Options:\
			...
			\n**NOTE 2**: Check ${CYAN}https://github.com/Voltblockchain/VOLT-MultiMN/wiki/Commands${NC} for extended info and usage examples of each command.\
			\n**NOTE 3**: Check ${CYAN}https://github.com/Voltblockchain/VOLT-MultiMN/wiki/FAQs${NC} for technical questions and troubleshooting."
}
function cmd_update() {
	curl -sL https://raw.githubusercontent.com/Voltblockchain/VOLT-MultiMN/main/multimn_install.sh 3>&3 | bash
	exit
}
